...
export const themeConfig: ThemeConfig = {
  ...
  global: {
    // default language
    locale: 'ja', // de, en, es, fr, ja, ko, pl, pt, ru, zh, zh-tw
    // more languages
  ...
  seo: {
    ...
    googleAnalyticsID: 'G-FPY99RM67V',
    // umami analytics
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'GitHub',
        url: 'https://github.com/sasakiy84/',
      },
      {
        name: 'X',
        url: 'https://x.com/sasakiy84',
      },
    ],
